...
plot11 = ggplot(sim_strains_r, aes(length, succes, group = 1)) + geom_point(color = 'blue', alpha = 0.3) + geom_smooth(method="lm") + theme_classic() + geom_point(data = cast.phen, aes(length , succes , group = 1), color = 'red')
plot12 = ggplot(sim_strains_r, aes(length, tsc   , group = 1)) + geom_point(color = 'blue', alpha = 0.3) + geom_smooth(method="lm") + theme_classic() + geom_point(data = cast.phen, aes(length , tsc    , group = 1), color = 'red')
plot13 = ggplot(sim_strains_r, aes(length, viab  , group = 1)) + geom_point(color = 'blue', alpha = 0.3) + geom_smooth(method="lm") + theme_classic() + geom_point(data = cast.phen, aes(length , viab   , group = 1), color = 'red')
plot21 = ggplot(sim_strains_r, aes(tsc   , succes, group = 1)) + geom_point(color = 'blue', alpha = 0.3) + geom_smooth(method="lm") + theme_classic() + geom_point(data = cast.phen, aes(tsc    , succes , group = 1), color = 'red')
plot22 = ggplot(sim_strains_r, aes(tsc   , viab  , group = 1)) + geom_point(color = 'blue', alpha = 0.3) + geom_smooth(method="lm") + theme_classic() + geom_point(data = cast.phen, aes(tsc    , viab   , group = 1), color = 'red')
plot23 = ggplot(sim_strains_r, aes(viab  , succes, group = 1)) + geom_point(color = 'blue', alpha = 0.3) + geom_smooth(method="lm") + theme_classic() + geom_point(data = cast.phen, aes(viab   , succes , group = 1), color = 'red')
