...
plot11 = plot11 + geom_point(data = cast_phen, aes(length, succes, group = 1), color = 'red') + labs(x = 'spore size', y = 'sucess')
plot12 = plot12 + geom_point(data = cast_phen, aes(length, tsc   , group = 1), color = 'red') + labs(x = 'spore size', y = 'total spore count')
plot13 = plot13 + geom_point(data = cast_phen, aes(length, viab  , group = 1), color = 'red') + labs(x = 'spore size', y = 'viability')
plot21 = plot21 + geom_point(data = cast_phen, aes(tsc   , succes, group = 1), color = 'red') + labs(x = 'total spore count', y = 'sucess')
plot22 = plot22 + geom_point(data = cast_phen, aes(tsc   , viab  , group = 1), color = 'red') + labs(x = 'total spore count', y = 'viability')
plot23 = plot23 + geom_point(data = cast_phen, aes(viab  , succes, group = 1), color = 'red') + labs(x = 'viability', y = 'sucess')
...
suc_tsc_plot = suc_tsc_plot + geom_point(data = cast_phen, aes(tsc, succes, group = 1), color = 'red') + labs(x = 'total spore count', y = 'succes')
via_tsc_plot = via_tsc_plot + geom_point(data = cast_phen, aes(tsc, viab  , group = 1), color = 'red') + labs(x = 'total spore count', y = 'viability')
fit_tsc_plot = ggplot(sim_phens , aes(tsc , fitness , group = 1)) + geom_point(alpha = 0.3) + geom_smooth(color = 'black') + theme_classic(base_size = 20)
fit_tsc_plot = fit_length_plot + labs(x = 'total spore count', y = 'fitness')
...
suc_length_plot = suc_length_plot + geom_point(data = cast_phen, aes(length, succes, group = 1), color = 'red')  + labs(x = 'spore size', y = 'succes')
via_length_plot = via_length_plot + geom_point(data = cast_phen, aes(length, viab  , group = 1), color = 'red') + labs(x = 'spore size', y = 'viability')
fit_length_plot = ggplot(sim_phens , aes(length , fitness , group = 1)) + geom_point(alpha = 0.3) + geom_smooth(color = 'black') + theme_classic(base_size = 20)
fit_length_plot = fit_length_plot + labs(x = 'spore size', y = 'fitness')
tiff("./figures/fitness_length.tiff", heigh = 500, width = 1080)
